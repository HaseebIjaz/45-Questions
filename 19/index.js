...
const nextGuestToInvite = "Sahil Adeem";
const notComing = (_a = invitedPeople.pop()) !== null && _a !== void 0 ? _a : "";
...
//19
//Number of people being invited to the dinner
console.log("Number of people being invited to the dinner : ", invitedPeople.length);
